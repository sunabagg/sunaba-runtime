...
Main.prototype.init = function(self) 
  local uiDocument = gdx.UiDocument.__new(self:get_ioInterface());
  ...
  local counter = 0;
  __bolt_core_LuaEvent.add(button.pressed, function() 
    counter = counter + 1;
...
__bolt_core_LuaEvent.new = {}
__bolt_core_LuaEvent.__name__ = true
__bolt_core_LuaEvent.add = function(event,func) 
  event.add(func);
end
__bolt_core_LuaEvent.remove = function(event,func) 
  event.remove(func);
end
...
__bolt_godot__Quaternion_Quaternion_Impl_.__name__ = true
...
__bolt_godot__Vector2i_Vector2i_Impl_.__name__ = true
...
__bolt_godot__Vector3i_Vector3i_Impl_.__name__ = true
...
__bolt_godot__Vector4_Vector4_Impl_.__name__ = true
...
__bolt_godot__Vector4i_Vector4i_Impl_.__name__ = true
